...
from .generated.openapi_aclient.models.objective_validator_request import (
    ObjectiveValidatorRequest as AObjectiveValidatorRequest,
)
from .generated.openapi_client.models.objective_validator_request import ObjectiveValidatorRequest
...
class AValidator:
    ...
    async def _ato_request(self, skills: Skills) -> AObjectiveValidatorRequest:
        ...
        return AObjectiveValidatorRequest(
...
def APredicateValidator(evaluator_id: str, threshold: float) -> AValidator:  # noqa: N802
    """Deprecated name for Validator; please use Validator."""

    return AValidator(evaluator_id=evaluator_id, threshold=threshold)
