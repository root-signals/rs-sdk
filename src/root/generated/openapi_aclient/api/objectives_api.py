...
class ObjectivesApi:
    ...
    async def objectives_list(
        self,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        has_validators: Annotated[Optional[StrictBool], Field(description="Filter objectives by whether they have validators.")] = None,
        intent: Annotated[Optional[StrictStr], Field(description="Search for objectives by intent (exact match).")] = None,
    ...
    @validate_call
    async def objectives_objectives_execute_create(
        self,
        ...
        """objectives_objectives_execute_create
        ...
        _param = self._objectives_objectives_execute_create_serialize(
    ...
    @validate_call
    async def objectives_objectives_execute_create_with_http_info(
        self,
        objective_id: StrictStr,
        objective_execution_request: ObjectiveExecutionRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def objectives_objectives_execute_create_without_preload_content(
        self,
        objective_id: StrictStr,
        objective_execution_request: ObjectiveExecutionRequest,
        _request_timeout: Union[
    ...
    def _objectives_objectives_execute_create_serialize(
        self,
        objective_id,
