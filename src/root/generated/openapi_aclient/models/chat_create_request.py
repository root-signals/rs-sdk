...
class ChatCreateRequest(BaseModel):
    ...
    history_from_chat_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Chat to copy the message history from.")
    __properties: ClassVar[List[str]] = ["chat_id", "skill_id", "name", "assistant_welcome_messages", "history_from_chat_id"]
