...
class ExecutionLogDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chat_id", "cost", "created_at", "id", "justification", "llm_output", "model", "model_call_duration", "model_params", "objective", "owner", "rendered_prompt", "skill", "validation_results", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objective": ExecutionLogDetailsObjective.from_dict(obj["objective"]) if obj.get("objective") is not None else None,
            ...
            "validation_results": [SkillExecutionValidatorResult.from_dict(_item) for _item in obj["validation_results"]] if obj.get("validation_results") is not None else None,
