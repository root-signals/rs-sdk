...
class PatchedSkillRequest(BaseModel):
    ...
    evaluator_only_offline: Optional[StrictBool] = Field(default=None, description="Do not run the evaluator if used as an Objective validator.")
    ...
    objective_version_id: Optional[StrictStr] = Field(default=None, description="Optionally pin the Skill to a specific version of an Objective. If not provided, the latest version of the objective will be used and followed.")
    overwrite: Optional[StrictBool] = Field(default=False, description="Overwrite existing skill with the same name. Only for POST requests.")
    pii_filter: Optional[StrictBool] = Field(default=None, description="Filter out personally identifiable information before sending a prompt to a LLM")
    prompt: Optional[StrictStr] = None
    reference_variables: Optional[List[ReferenceVariableRequest]] = None
    status: Optional[StatusEnum] = None
    system_message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["change_note", "data_loaders", "evaluator_demonstrations", "evaluator_only_offline", "evaluator_require_reference_variables", "input_variables", "is_evaluator", "model_params", "models", "name", "objective", "objective_id", "objective_version_id", "overwrite", "pii_filter", "prompt", "reference_variables", "status", "system_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_loaders": [DataLoaderRequest.from_dict(_item) for _item in obj["data_loaders"]] if obj.get("data_loaders") is not None else None,
            "evaluator_demonstrations": [EvaluatorDemonstrationsRequest.from_dict(_item) for _item in obj["evaluator_demonstrations"]] if obj.get("evaluator_demonstrations") is not None else None,
            ...
            "input_variables": [InputVariableRequest.from_dict(_item) for _item in obj["input_variables"]] if obj.get("input_variables") is not None else None,
            "is_evaluator": obj.get("is_evaluator"),
            "model_params": ModelParamsRequest.from_dict(obj["model_params"]) if obj.get("model_params") is not None else None,
            ...
            "reference_variables": [ReferenceVariableRequest.from_dict(_item) for _item in obj["reference_variables"]] if obj.get("reference_variables") is not None else None,
