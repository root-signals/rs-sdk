...
from root.generated.openapi_aclient.models.reference_variable_dynamic_datasets_request import ReferenceVariableDynamicDatasetsRequest
from typing import Optional, Set
from typing_extensions import Self

class ChatExecutionRequestRequest(BaseModel):
    """
    ...
    dynamic_datasets: Optional[List[ReferenceVariableDynamicDatasetsRequest]] = Field(default=None, description="Specify the dataset for a reference variable.")
    language: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = 'en'
    correlation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Unique ID to track message status. If not provided, status tracking will not be available.")
    __properties: ClassVar[List[str]] = ["skill_version_id", "variables", "model_params", "dynamic_datasets", "language", "correlation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatExecutionRequestRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatExecutionRequestRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dynamic_datasets": [ReferenceVariableDynamicDatasetsRequest.from_dict(_item) for _item in obj["dynamic_datasets"]] if obj.get("dynamic_datasets") is not None else None,
