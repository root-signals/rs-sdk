...
class Skill(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["change_note", "created_at", "data_loaders", "evaluator_demonstrations", "evaluator_only_offline", "evaluator_require_reference_variables", "id", "input_variables", "is_evaluator", "model_params", "models", "name", "objective", "owner", "pii_filter", "prompt", "reference_variables", "skill_type", "status", "system_message", "updated_at", "updated_by", "version_id", "_meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data_loaders": [DataLoader.from_dict(_item) for _item in obj["data_loaders"]] if obj.get("data_loaders") is not None else None,
            "evaluator_demonstrations": [EvaluatorDemonstrations.from_dict(_item) for _item in obj["evaluator_demonstrations"]] if obj.get("evaluator_demonstrations") is not None else None,
            ...
            "id": obj.get("id"),
            "input_variables": [InputVariable.from_dict(_item) for _item in obj["input_variables"]] if obj.get("input_variables") is not None else None,
            "is_evaluator": obj.get("is_evaluator"),
            "model_params": ModelParams.from_dict(obj["model_params"]) if obj.get("model_params") is not None else None,
            ...
            "reference_variables": [ReferenceVariable.from_dict(_item) for _item in obj["reference_variables"]] if obj.get("reference_variables") is not None else None,
