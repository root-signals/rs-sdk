...
class EvaluatorCalibrationOutput(BaseModel):
    ...
    model_call_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Deprecated, use result.model_call_duration instead.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": EvaluatorCalibrationResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
