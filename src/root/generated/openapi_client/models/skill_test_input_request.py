...
class SkillTestInputRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["test_data", "test_dataset_id", "prompt", "reference_variables", "data_loaders", "input_variables", "models", "name", "pii_filter", "objective", "is_evaluator"]
