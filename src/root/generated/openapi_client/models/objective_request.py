...
class ObjectiveRequest(BaseModel):
    ...
    force_create: Optional[StrictBool] = Field(default=None, description="Force creation of a new objective. Applies only to PUT requests.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validators": [ObjectiveValidatorRequest.from_dict(_item) for _item in obj["validators"]] if obj.get("validators") is not None else None,
