...
class ObjectivesApi:
    ...
    @validate_call
    def objectives_test_set_append_create(
        self,
        objective_id: StrictStr,
        ...
        """objectives_test_set_append_create

        Append a test set to an Objective.

        :param objective_id: (required)
        :type objective_id: str
        :param variables_request: (required)
        :type variables_request: VariablesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._objectives_test_set_append_create_serialize(
            objective_id=objective_id,
    ...
    @validate_call
    def objectives_test_set_append_create_with_http_info(
        self,
        objective_id: StrictStr,
        variables_request: VariablesRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def objectives_test_set_append_create_without_preload_content(
        self,
        objective_id: StrictStr,
        variables_request: VariablesRequest,
        _request_timeout: Union[
    ...
    def _objectives_test_set_append_create_serialize(
        self,
        objective_id,
        variables_request,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if variables_request is not None:
            _body_params = variables_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/objectives/{objective_id}/test-set/append",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
