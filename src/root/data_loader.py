...
class _ADataLoaderBase(ABC):
    type: _ADataLoaderTypeEnum
    name: str
...
class AWebPageDataLoader(_ADataLoaderBase):
    """Data loader which retrieves data from a web page
    ...
    type = _ADataLoaderTypeEnum.WEBPAGE
...
class AWebSearchDataLoader(_ADataLoaderBase):
    """Data loader which retrieves data from web search
    ...
    type = _ADataLoaderTypeEnum.WEBSEARCH
...
class ASqlDataLoader(_ADataLoaderBase):
    """Data loader which retrieves data from SQL
...
class AApiCallDataLoader(_ADataLoaderBase):
    """Data loader which retrieves data from an URL
    ...
    type = _ADataLoaderTypeEnum.API_CALL
