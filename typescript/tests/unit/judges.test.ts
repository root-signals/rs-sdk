...
describe('JudgesResource', () => {
  ...
  describe('list', () => {
    it('should list judges successfully', async () => {
      mockClient.setMockResponse('GET', '/beta/judges/', {
    ...
    it('should handle pagination parameters', async () => {
      ...
      expect(mockClient.GET).toHaveBeenCalledWith('/beta/judges/', {
        params: {
  ...
  describe('get', () => {
    it('should get judge by ID', async () => {
      ...
      mockClient.setMockResponse('GET', `/beta/judges/${judgeId}/`, {
  ...
  describe('create', () => {
    it('should create judge successfully', async () => {
      ...
      mockClient.setMockResponse('POST', '/beta/judges/', {
        data: createdJudge,
        error: undefined
      });
      ...
      expect(mockClient.POST).toHaveBeenCalledWith('/beta/judges/', {
        body: judgeData
      });
    });

    it('should handle validation errors', async () => {
      mockClient.setMockError('POST', '/beta/judges/', {
        name: ['This field is required.']
      });

      await expect(
        client.judges.create({ intent: 'Missing name' })
      ).rejects.toThrow();
    });
  });
  ...
  describe('update', () => {
    it('should update judge successfully', async () => {
      ...
      const updatedJudge = TestDataFactory.createJudge({ id: judgeId, ...updateData });
      mockClient.setMockResponse('PUT', `/beta/judges/${judgeId}/`, {
        data: updatedJudge,
        error: undefined
      });
      ...
      expect(mockClient.PUT).toHaveBeenCalledWith(`/beta/judges/${judgeId}/`, {
  ...
  describe('patch', () => {
    it.skip('should partially update judge', async () => {
      ...
      const patchedJudge = TestDataFactory.createJudge({ id: judgeId, ...patchData });
      mockClient.setMockResponse('PATCH', `/beta/judges/${judgeId}/`, {
        data: patchedJudge,
        error: undefined
      });
      ...
      expect(mockClient.PATCH).toHaveBeenCalledWith(`/beta/judges/${judgeId}/`, {
        params: { path: { id: judgeId } },
        body: patchData
      });
    });
  ...
  describe('delete', () => {
    it('should delete judge successfully', async () => {
      const judgeId = 'judge-123';
      mockClient.setMockResponse('DELETE', `/beta/judges/${judgeId}/`, {
        data: undefined,
        error: undefined
      });
      ...
      expect(mockClient.DELETE).toHaveBeenCalledWith(`/beta/judges/${judgeId}/`, {
        params: { path: { id: judgeId } }
      });
    });
    ...
    it('should handle delete errors', async () => {
      const judgeId = 'judge-123';
      mockClient.setMockError('DELETE', `/beta/judges/${judgeId}/`, {
  ...
  describe('execute', () => {
    it('should execute judge successfully', async () => {
      ...
      mockClient.setMockResponse('POST', `/beta/judges/${judgeId}/execute/`, {
      ...
      expect(mockClient.POST).toHaveBeenCalledWith(`/beta/judges/${judgeId}/execute/`, {
  ...
  describe('generate', () => {
    it('should generate judge with string intent', async () => {
      ...
      mockClient.setMockResponse('POST', '/beta/judges/generate/', {
      ...
      expect(mockClient.POST).toHaveBeenCalledWith('/beta/judges/generate/', {
        body: { intent }
      });
    });
  ...
  describe('duplicate', () => {
    it('should duplicate judge successfully', async () => {
      ...
      mockClient.setMockResponse('POST', `/beta/judges/${judgeId}/duplicate/`, {
      ...
      expect(mockClient.POST).toHaveBeenCalledWith(`/beta/judges/${judgeId}/duplicate/`, {
        params: { path: { id: judgeId } }
      });
    });
  });
  ...
  describe('invite', () => {
    it.skip('should send invitations successfully', async () => {
      ...
      mockClient.setMockResponse('POST', `/beta/judges/${judgeId}/invite/`, {
        data: { success: true },
        error: undefined
      });
      ...
      expect(mockClient.POST).toHaveBeenCalledWith(`/beta/judges/${judgeId}/invite/`, {
        params: { path: { id: judgeId } },
        body: { emails }
      });
    });
    ...
    it.skip('should handle too many emails', async () => {
      ...
      mockClient.setMockError('POST', `/beta/judges/${judgeId}/invite/`, {
        emails: ['Maximum 10 emails allowed.']
      });

      await expect(
        client.judges.invite(judgeId, tooManyEmails)
      ).rejects.toThrow();
    });
  });
});